        ...
        try:
            ...
            try:
                ...
                if result.returncode != 0:
                    ...
                    if progress_callback:
                        progress_callback(
                            "❌ Installation fehlgeschlagen - Administrator-Rechte verweigert oder Timeout")
                    return False
                ...
                if chmod_result.returncode != 0:
                    ...
                    if progress_callback:
                        progress_callback(
                            "⚠️ Berechtigung setzen fehlgeschlagen, aber Installation möglicherweise erfolgreich")
